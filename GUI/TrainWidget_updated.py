...
#-------------------------------------------------------------------------------------------------
    ...
    def train_cmd(self):
        ...
        train_cmd_str = './darknet detector train mod/voc_gui.data mod/yolov3-voc_gui.cfg darknet53.conv.74 -gpus 0,1'
        #train_cmd_str = './darknet detector train mod/voc_gui.data mod/yolov3-voc_gui.cfg backup/yolov3-voc_gui.backup -gpus 0,1'
